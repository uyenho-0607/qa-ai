...
**⚠ Contradicts `.claude/domain/otc-bo.md`**, which records Member Management as "Admin: view only" and
...
No `data-testid` exists in this application. Cached selectors: `.claude/locator-cache.json`.
