...
Usage:
    # Single file + comment
    .venv/bin/python ~/.claude/skills/jira-handler/jira_comment.py --issue OMS-807 \
    ...
    # Delete a comment
    .venv/bin/python ~/.claude/skills/jira-handler/jira_comment.py --issue OMS-807 --delete 240061
"""
