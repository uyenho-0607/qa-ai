...
Usage:
    ...
    .venv/bin/python3 .claude/skills/jira-handler/jira_desc_update.py --issue OMS-807 \
    ...
    .venv/bin/python3 .claude/skills/jira-handler/jira_desc_update.py --get-media-uuid 110043

    # Get multiple media UUIDs at once (comma-separated)
    .venv/bin/python3 .claude/skills/jira-handler/jira_desc_update.py --get-media-uuid 111913,111914
"""
