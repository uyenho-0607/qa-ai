...
Usage:
    .venv/bin/python3 .claude/skills/jira-handler/jira_attach.py --issue OMS-807 --file ./video.mp4 --filename name.mp4
    .venv/bin/python3 .claude/skills/jira-handler/jira_attach.py --issue OMS-807 --file ./a.png --filename a.png --file ./b.mp4 --filename b.mp4
"""
