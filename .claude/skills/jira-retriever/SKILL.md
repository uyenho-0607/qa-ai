...
When `save` is given: write directly to `tasks/{KEY}/jira.md` without showing the content in chat. After writing, say "Written to `tasks/{KEY}/jira.md` — check it and flag anything to update."

When `save` is not given: return content in chat using this structure:
