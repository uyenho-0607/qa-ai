...
- **Reads:** `.claude/steering/project-config.md`, `tasks/{KEY}/base/jira.md`, `tasks/{KEY}/base/tc.md`
- **Writes:** `tasks/{KEY}/exec/exec-v2.md`, recon screenshots to `tasks/{KEY}/exec/recon/`, Tier-1 evidence to
  `tasks/{KEY}/exec/evidence/`, verified locators to `.claude/locator-cache.json`
...
Apply `.claude/steering/tc-exec-classify.md` to every TC, sheet and added alike. A TC that is
