...
- **Writes:** `tasks/{KEY}/exec.md` (result lines, in place), `tasks/{KEY}/report.md`, evidence to `evidence/{KEY}/` — the paths `.claude/steering/project-config.md` § Folder Structure fixes
