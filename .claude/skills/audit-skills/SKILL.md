...
- **Delegates:** form of a convention file → invoke the `writing-conventions` skill, Audit branch. Pointer strength, no-ops, information hierarchy → invoke the `writing-for-agents` skill.
...
python3 .claude/skills/audit-skills/find-dupes.py <files in scope>
```
