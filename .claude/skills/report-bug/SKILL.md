...
2. Read `.claude/steering/jira.md` (project ids, dev team) + `project-config.md` (URLs)
...
- Evidence source: allure-results (`Read .claude/skills/allure-reader/SKILL.md`) or Playwright browser
...
4. `Read .claude/skills/capture-evidence/SKILL.md` — never capture manually

### 4. Create Bug
`Read .claude/skills/jira-handler/SKILL.md` action: `create_bug`
