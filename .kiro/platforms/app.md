...
|---|---|---|
| `ios` | Member app (iOS) | `.kiro/steering/mobile-mcp-rule.md` |
| `android` | Member app | `.kiro/steering/mobile-mcp-rule.md` |
| `app-web` | Member app (web) | `.kiro/steering/playwright-rule.md` |
