...
description: >
  ...
  .kiro/domain/ knowledge base files. Use when user says "learn domain",
...
1. **Determine scope:**
   ...
   - If no topic specified, capture learnings from the CURRENT conversation session — what new info was discovered during work that isn't yet in `.kiro/domain/`
...
3. **Update knowledge base:**
   - Read the existing relevant `.kiro/domain/` file first
