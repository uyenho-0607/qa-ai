...
- **Reads:** `tasks/{KEY}/exec/exec-v2.md`, `.kiro/steering/project-config.md`
...
**Loads, at Phase 2 and not before:** `.kiro/docs/lessons.md`, `.kiro/steering/capture-mechanics.md`, and
...
re-run → append one bullet to `.kiro/docs/lessons.md` with `{KEY}` and the date. Skip where nothing is
