...
|---|---|---|
| `web` | `.kiro/steering/playwright-rule.md` | `.kiro/steering/capture-web.md` |
| `device` | `.kiro/steering/maestro-rule.md` | `.kiro/steering/capture-device.md` |
...
- `{stem}` — the caller's. An exec run takes it from the plan, per
  `.kiro/skills/manual-exec-design/references/evidence.md` § File Naming (Stem); `report-bug` passes
